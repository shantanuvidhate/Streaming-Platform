...
interface inputProps{
    ...
    value:string,
    label:string,
    type?:string;   // type is an optional property
}
const Input : React.FC<inputProps> = ({
    ...
    return (
        <div className="relative">
            <input id={id} value={value} type={type} onChange={onChange} className="block rounded-md px-6 pt-6 pb-1 w-full text-base text-white bg-neutral-700 appearance-none focus:outline-none focus:ring-0 peer" placeholder="" />
